...
pkgs.mkShell {
  ...
  shellHook = ''
    ...
    echo ""
    echo -e "  \033[1;35m[ VM-FIRST SHELL ]\033[0m  \033[90m(shell-minimal.nix)\033[0m"
    echo -e "  \033[33mFull toolchain is inside the VM — host has orchestration only.\033[0m"
    echo ""
