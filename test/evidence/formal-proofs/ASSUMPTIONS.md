...
| ED-008a | Spec.Ed25519 | `scalar_mult_congruence` | DERIVED_FROM_ALGEBRA | no | ED-003 | Projective equivalence preserved by scalar_mult. Abstract Section proof in Ed25519ScalarMultCongruence.v: both H_cong_left (Ed25519CongruenceUniversal.v) and H_cong_right (Ed25519CongruenceRight.v, 2026-06-07) are now DISCHARGED. Full concrete instantiation pending ext_wf preservation through scalar_mult recursion. | Standard projective geometry | Instantiate AbstractCongruence with ext_wf bridge | PARTIALLY_PROVED |
