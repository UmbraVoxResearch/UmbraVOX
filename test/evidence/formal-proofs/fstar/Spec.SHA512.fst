...
(** -------------------------------------------------------------------- **)
(** FIPS 180-4 constant verification                                     **)
(**                                                                       **)
(** Verify each SHA-512 round constant (K table, Section 4.2.3) and      **)
(** initial hash value (IV, Section 5.3.5) against the specification.     **)
(** SHA-256 already verifies all 64 K values; we do the same for all 80. **)
(** -------------------------------------------------------------------- **)

(** IV verification -- FIPS 180-4, Section 5.3.5 *)
let _ = assert_norm (Seq.index init_hash 0 == 0x6a09e667f3bcc908uL)
let _ = assert_norm (Seq.index init_hash 1 == 0xbb67ae8584caa73buL)
let _ = assert_norm (Seq.index init_hash 2 == 0x3c6ef372fe94f82buL)
let _ = assert_norm (Seq.index init_hash 3 == 0xa54ff53a5f1d36f1uL)
let _ = assert_norm (Seq.index init_hash 4 == 0x510e527fade682d1uL)
let _ = assert_norm (Seq.index init_hash 5 == 0x9b05688c2b3e6c1fuL)
let _ = assert_norm (Seq.index init_hash 6 == 0x1f83d9abfb41bd6buL)
let _ = assert_norm (Seq.index init_hash 7 == 0x5be0cd19137e2179uL)

(** K table verification -- FIPS 180-4, Section 4.2.3 (all 80 constants) *)
let _ = assert_norm (Seq.index k_table 0  == 0x428a2f98d728ae22uL)
let _ = assert_norm (Seq.index k_table 1  == 0x7137449123ef65cduL)
let _ = assert_norm (Seq.index k_table 2  == 0xb5c0fbcfec4d3b2fuL)
let _ = assert_norm (Seq.index k_table 3  == 0xe9b5dba58189dbbcuL)
let _ = assert_norm (Seq.index k_table 4  == 0x3956c25bf348b538uL)
let _ = assert_norm (Seq.index k_table 5  == 0x59f111f1b605d019uL)
let _ = assert_norm (Seq.index k_table 6  == 0x923f82a4af194f9buL)
let _ = assert_norm (Seq.index k_table 7  == 0xab1c5ed5da6d8118uL)
let _ = assert_norm (Seq.index k_table 8  == 0xd807aa98a3030242uL)
let _ = assert_norm (Seq.index k_table 9  == 0x12835b0145706fbeuL)
let _ = assert_norm (Seq.index k_table 10 == 0x243185be4ee4b28cuL)
let _ = assert_norm (Seq.index k_table 11 == 0x550c7dc3d5ffb4e2uL)
let _ = assert_norm (Seq.index k_table 12 == 0x72be5d74f27b896fuL)
let _ = assert_norm (Seq.index k_table 13 == 0x80deb1fe3b1696b1uL)
let _ = assert_norm (Seq.index k_table 14 == 0x9bdc06a725c71235uL)
let _ = assert_norm (Seq.index k_table 15 == 0xc19bf174cf692694uL)

let _ = assert_norm (Seq.index k_table 16 == 0xe49b69c19ef14ad2uL)
let _ = assert_norm (Seq.index k_table 17 == 0xefbe4786384f25e3uL)
let _ = assert_norm (Seq.index k_table 18 == 0x0fc19dc68b8cd5b5uL)
let _ = assert_norm (Seq.index k_table 19 == 0x240ca1cc77ac9c65uL)
let _ = assert_norm (Seq.index k_table 20 == 0x2de92c6f592b0275uL)
let _ = assert_norm (Seq.index k_table 21 == 0x4a7484aa6ea6e483uL)
let _ = assert_norm (Seq.index k_table 22 == 0x5cb0a9dcbd41fbd4uL)
let _ = assert_norm (Seq.index k_table 23 == 0x76f988da831153b5uL)
let _ = assert_norm (Seq.index k_table 24 == 0x983e5152ee66dfabuL)
let _ = assert_norm (Seq.index k_table 25 == 0xa831c66d2db43210uL)
let _ = assert_norm (Seq.index k_table 26 == 0xb00327c898fb213fuL)
let _ = assert_norm (Seq.index k_table 27 == 0xbf597fc7beef0ee4uL)
let _ = assert_norm (Seq.index k_table 28 == 0xc6e00bf33da88fc2uL)
let _ = assert_norm (Seq.index k_table 29 == 0xd5a79147930aa725uL)
let _ = assert_norm (Seq.index k_table 30 == 0x06ca6351e003826fuL)
let _ = assert_norm (Seq.index k_table 31 == 0x142929670a0e6e70uL)

let _ = assert_norm (Seq.index k_table 32 == 0x27b70a8546d22ffcuL)
let _ = assert_norm (Seq.index k_table 33 == 0x2e1b21385c26c926uL)
let _ = assert_norm (Seq.index k_table 34 == 0x4d2c6dfc5ac42aeduL)
let _ = assert_norm (Seq.index k_table 35 == 0x53380d139d95b3dfuL)
let _ = assert_norm (Seq.index k_table 36 == 0x650a73548baf63deuL)
let _ = assert_norm (Seq.index k_table 37 == 0x766a0abb3c77b2a8uL)
let _ = assert_norm (Seq.index k_table 38 == 0x81c2c92e47edaee6uL)
let _ = assert_norm (Seq.index k_table 39 == 0x92722c851482353buL)
let _ = assert_norm (Seq.index k_table 40 == 0xa2bfe8a14cf10364uL)
let _ = assert_norm (Seq.index k_table 41 == 0xa81a664bbc423001uL)
let _ = assert_norm (Seq.index k_table 42 == 0xc24b8b70d0f89791uL)
let _ = assert_norm (Seq.index k_table 43 == 0xc76c51a30654be30uL)
let _ = assert_norm (Seq.index k_table 44 == 0xd192e819d6ef5218uL)
let _ = assert_norm (Seq.index k_table 45 == 0xd69906245565a910uL)
let _ = assert_norm (Seq.index k_table 46 == 0xf40e35855771202auL)
let _ = assert_norm (Seq.index k_table 47 == 0x106aa07032bbd1b8uL)

let _ = assert_norm (Seq.index k_table 48 == 0x19a4c116b8d2d0c8uL)
let _ = assert_norm (Seq.index k_table 49 == 0x1e376c085141ab53uL)
let _ = assert_norm (Seq.index k_table 50 == 0x2748774cdf8eeb99uL)
let _ = assert_norm (Seq.index k_table 51 == 0x34b0bcb5e19b48a8uL)
let _ = assert_norm (Seq.index k_table 52 == 0x391c0cb3c5c95a63uL)
let _ = assert_norm (Seq.index k_table 53 == 0x4ed8aa4ae3418acbuL)
let _ = assert_norm (Seq.index k_table 54 == 0x5b9cca4f7763e373uL)
let _ = assert_norm (Seq.index k_table 55 == 0x682e6ff3d6b2b8a3uL)
let _ = assert_norm (Seq.index k_table 56 == 0x748f82ee5defb2fcuL)
let _ = assert_norm (Seq.index k_table 57 == 0x78a5636f43172f60uL)
let _ = assert_norm (Seq.index k_table 58 == 0x84c87814a1f0ab72uL)
let _ = assert_norm (Seq.index k_table 59 == 0x8cc702081a6439ecuL)
let _ = assert_norm (Seq.index k_table 60 == 0x90befffa23631e28uL)
let _ = assert_norm (Seq.index k_table 61 == 0xa4506cebde82bde9uL)
let _ = assert_norm (Seq.index k_table 62 == 0xbef9a3f7b2c67915uL)
let _ = assert_norm (Seq.index k_table 63 == 0xc67178f2e372532buL)

let _ = assert_norm (Seq.index k_table 64 == 0xca273eceea26619cuL)
let _ = assert_norm (Seq.index k_table 65 == 0xd186b8c721c0c207uL)
let _ = assert_norm (Seq.index k_table 66 == 0xeada7dd6cde0eb1euL)
let _ = assert_norm (Seq.index k_table 67 == 0xf57d4f7fee6ed178uL)
let _ = assert_norm (Seq.index k_table 68 == 0x06f067aa72176fbauL)
let _ = assert_norm (Seq.index k_table 69 == 0x0a637dc5a2c898a6uL)
let _ = assert_norm (Seq.index k_table 70 == 0x113f9804bef90daeuL)
let _ = assert_norm (Seq.index k_table 71 == 0x1b710b35131c471buL)
let _ = assert_norm (Seq.index k_table 72 == 0x28db77f523047d84uL)
let _ = assert_norm (Seq.index k_table 73 == 0x32caab7b40c72493uL)
let _ = assert_norm (Seq.index k_table 74 == 0x3c9ebe0a15c9bebcuL)
let _ = assert_norm (Seq.index k_table 75 == 0x431d67c49c100d4cuL)
let _ = assert_norm (Seq.index k_table 76 == 0x4cc5d4becb3e42b6uL)
let _ = assert_norm (Seq.index k_table 77 == 0x597f299cfc657e2auL)
let _ = assert_norm (Seq.index k_table 78 == 0x5fcb6fab3ad6faecuL)
let _ = assert_norm (Seq.index k_table 79 == 0x6c44198c4a475817uL)
